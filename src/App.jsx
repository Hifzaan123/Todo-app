      ...
      <h1 className='font-bold text-center text-3xl'>iTask - Manage your todos at one place</h1>
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <div className="flex">
            ...
            <button onClick={handleAdd} disabled={todo.length<3} className='bg-violet-800 hover:bg-violet-950 p-4 py-2 text-white rounded-full disabled:bg-violet-600 text-sm mx-2 font-bold'>Save</button>
          </div>
        </div>
        <input className='my-4' id='show' onChange={toggleFinished} type="checkbox" checked={showfinish} />
        ...
        <div className="todos">
          {todos.map(item=>{
            ...
            return (showfinish || !item.isCompleted) && <div key={item.id} className="todo flex justify-between my-3">
